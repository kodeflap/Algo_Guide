 ...
 *
 * @constructor Creates an instance of the BubbleSort class
 */
...
class BubbleSort {
    suspend fun bubbleSort(
        ...
        while (1 < arr.size) {
            ...
            var swap = true
            while (swap) {
                /*Initially keeping swap as false */
                swap = false
                /*Iterating over the whole array */
                for (i in 0 until arr.size - 1) {
                    /*If the adjacent element is greater then the previous element then perform the
